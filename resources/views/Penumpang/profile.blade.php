                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form method="POST" action="{{ route('penumpang.profile.update') }}" autocomplete="off"
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form method="POST" action="{{ route('penumpang.profile.updatepassword') }}" autocomplete="off"
                                    enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="row mb-3">
                                        <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">New
                                            Password</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input type="password" id="new_password" class="form-control" name="new_password" placeholder="New password" placeholder="Current password">
                                        </div>
                                    </div>
