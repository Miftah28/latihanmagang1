...
@section('main-content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- Vertical Form -->
            <form class="row g-3"action="{{ route('admin.daerah.update', Crypt::encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="col-12">
                    ...
                    <input id="nama_daerah" type="text" class="form-control @error('nama_daerah') is-invalid @enderror"
                        name="nama_daerah" value="{{ $data->nama_daerah}}" required autocomplete="nama_daerah" autofocus>
